#include "MWalker/TriggerFilter/interface/SimParticleFilter.h"
...
SimParticleFilter::SimParticleFilter(const edm::ParameterSet &iConfig)
{
  m_ptlow = -1;
  m_pthigh = 9999999;
  m_etalow = -2.5;
...
//-------------------------
//-------------------------
SimParticleFilter::~SimParticleFilter()
{
  /* no op */
}
//-------------------------
//-------------------------
void SimParticleFilter::produce(edm::Event & iEvent, const edm::EventSetup & iSetup)
{
...
DEFINE_FWK_MODULE(SimParticleFilter);
