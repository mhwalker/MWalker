#include "MWalker/TriggerFilter/interface/SimJetFilter.h"
...
SimJetFilter::SimJetFilter(const edm::ParameterSet &iConfig)
{
  m_ptlow = -1;
  m_pthigh = 9999999;
  m_etalow = -2.5;
...
//-------------------------
//-------------------------
SimJetFilter::~SimJetFilter()
{
  /* no op */
}
//-------------------------
//-------------------------
void SimJetFilter::produce(edm::Event & iEvent, const edm::EventSetup & iSetup)
{
...
DEFINE_FWK_MODULE(SimJetFilter);
